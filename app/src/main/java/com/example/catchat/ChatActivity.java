...
import com.example.catchat.adapters.AdapterChat;
import com.example.catchat.models.ModelChat;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void seenMessage() {
        usersDbRef = FirebaseDatabase.getInstance().getReference("Chats");
        seenListener=usersDbRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()){
    ...
    protected void onPause() {
        super.onPause();
        usersDbRef.removeEventListener(seenListener);
    }
